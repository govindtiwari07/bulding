!(function (e, t) {
  ...
  function w(e) {
    return /^https:\/\/player\.((vimeo\.com)|([a-zA-Z0-9-]+\.videoji\.hk))\/video\/\d+/.test(
      e
    );
  }
  ...
  function H(c, e, t) {
    var l = 1 < arguments.length && void 0 !== e ? e : {},
      s = 2 < arguments.length ? t : void 0;
    return new Promise(function (t, n) {
      if (!g(c))
      ...
      var e,
        ...
        o =
          ((e = (c || "").match(/^(?:https?:)?(?:\/\/)?([^/?]+)/)),
          (r = ((e && e[1]) || "").replace("player.", "")).endsWith(
            ".videoji.hk"
          )
            ? r
            : "vimeo.com"),
        i = "https://"
          .concat(o, "/api/oembed.json?url=")
          .concat(encodeURIComponent(c));
      for (var a in l)
        l.hasOwnProperty(a) &&
          (i += "&".concat(a, "=").concat(encodeURIComponent(l[a])));
      var u = new (
            ...
            if (403 !== u.status)
              try {
                ...
                if (403 === e.domain_status_code)
                  return (
                    B(e, s),
                    void n(new Error("“".concat(c, "” is not embeddable.")))
                  );
                t(e);
              } catch (e) {
                n(e);
              }
            else n(new Error("“".concat(c, "” is not embeddable.")));
          else n(new Error("“".concat(c, "” was not found.")));
        }),
        (u.onerror = function () {
